...
def addMedievalDocumentsCollections():
...
addMedievalDocumentsCollections()
addMedievalDocuments()
addRecords()
addPlaces()
addSettlementMentions()
addMonasteries()
addMentionsMonasteries()
